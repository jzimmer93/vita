 ...
 */
public class vitaSettings extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vita_settings_activity);

        Button signoutButton = (Button) findViewById(R.id.sign_out_button);
        Spinner spinner = (Spinner) findViewById(R.id.soundFileTypeSpinner);
        ...
        this.mAdapter = ArrayAdapter.createFromResource(this, R.array.AudioTypes,
        ...
        signoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                vsUtils.savePreferencesBool("UserLogged", false);
                Intent intent = new Intent(vitaSettings.this,VitaLoginActivity.class);
    ...
    public class myOnItemSelectedListener implements OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View v, int pos, long row) {
            ...
            vitaSettings.this.mPos = pos;
            vitaSettings.this.mSelection = parent.getItemAtPosition(pos).toString();
            /*
             * Set the value of the text field in the UI
             */
            // TextView resultText = (TextView)findViewById(R.id.SpinnerResult);
            //  resultText.setText(vitaSettings.this.mSelection);
        }
    ...
    public void onResume() {
        ...
        Spinner restoreSpinner = (Spinner) findViewById(R.id.soundFileTypeSpinner);
    ...
    public boolean readInstanceState(Context c) {
         ...
         */
        this.mPos = p.getInt(POSITION_KEY, vitaSettings.DEFAULT_POSITION);
    ...
    public boolean writeInstanceState(Context c) {
        ...
        SharedPreferences p = c.getSharedPreferences(vitaSettings.PREFERENCES_FILE, MODE_PRIVATE);
